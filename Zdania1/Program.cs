...
namespace ShopApp.Data
{
    ...
    public static class SampleData
    {
        ...
        private static List<Order> BuildOrders()
        {
            ...
            {
                new Order { Id = 1, Customer = c[0], OrderDate = new DateTime(2025, 1, 10), Status = OrderStatus.Completed,
                    Items = new() {
                ...
                new Order { Id = 2, Customer = c[0], OrderDate = new DateTime(2025, 3, 5), Status = OrderStatus.Processing,
                    Items = new() {
                ...
                new Order { Id = 3, Customer = c[1], OrderDate = new DateTime(2025, 2, 20), Status = OrderStatus.Validated,
                    Items = new() {
                ...
                new Order { Id = 4, Customer = c[2], OrderDate = new DateTime(2025, 3, 18), Status = OrderStatus.New,
                    Items = new() {
                ...
                new Order { Id = 5, Customer = c[3], OrderDate = new DateTime(2025, 1, 28), Status = OrderStatus.Cancelled,
                    Items = new() {
                ...
                new Order { Id = 6, Customer = c[3], OrderDate = new DateTime(2025, 3, 1), Status = OrderStatus.Completed,
                    Items = new() {
